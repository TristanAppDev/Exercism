...
(defn- upper? [text] (= (str/upper-case text) text))

(defn- question? [text] (str/ends-with? text "?"))
(defn- has-letter? [text] (some #(Character/isLetter %) text))
(defn- shouting? [text] (and (upper? text) (has-letter? text)))
