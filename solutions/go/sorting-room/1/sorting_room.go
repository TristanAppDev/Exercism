...
// NumberBox is a type that can be used to describe a number.
...
// FancyNumber is a type that can be used to describe a number.
type FancyNumber struct {
	n string
}

// Value returns the value of the FancyNumberBox.
func (i FancyNumber) Value() string {
	return i.n
}

// FancyNumberBox is a type that can be used to describe a fancy number.
