...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    efficiency_in_percent = (generated_power / theoretical_max_power) * 100

    if efficiency_in_percent >= 80:
        efficiency = "green"
    elif efficiency_in_percent >= 60:
        efficiency = "orange"
    elif efficiency_in_percent >= 30:
        efficiency = "red"
    else:
        efficiency = "black"
    return efficiency
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    current_state = temperature * neutrons_produced_per_second
    state_to_threshold_ratio = (current_state / threshold) * 100
    safety_range = ""

    if state_to_threshold_ratio < 40:
        safety_range = "LOW"
    elif 90 <= state_to_threshold_ratio <= 110:
        safety_range = "NORMAL"
    else:
        safety_range = "DANGER"
    return safety_range
